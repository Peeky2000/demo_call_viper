...
help:
	@echo "KaiCall — demo cuộc gọi video qua LiveKit (Android)"
	@echo ""
	@echo "  make doctor   kiểm Flutter + 4 biến env + thiết bị Android  ← chạy cái này trước"
	@echo "  make dev      cài và chạy lên thiết bị đang cắm"
	@echo "  make check    flutter analyze"
	@echo "  make test     22 test: máy trạng thái · ký token · tên phòng"
	@echo "  make deploy   build APK debug để cài tay (KHÔNG có PaaS nào)"
	@echo "  make migrate  không có DB — in ra lý do rồi thoát"
	@echo ""
	@echo "  Thử gọi cần HAI đầu: emulator + máy Android thật."
	@echo "  Ở một máy bấm 'đổi sang Minh' để hai bên đóng hai vai khác nhau."
	@echo ""
