...
`intake/loops/l<N>/_PROPOSAL.md`. Không có `E` → dừng tại đây, đi `$viper-repeat`;
`gate.py E` cũng tự bỏ qua. Vòng chưa deploy thì không có người dùng thật để đo
([VIPER.md §1.4](../../../VIPER.md)). Pha này tuỳ chọn và lặp lại được.
