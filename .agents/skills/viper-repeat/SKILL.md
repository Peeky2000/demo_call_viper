---
name: viper-repeat
description: Quyết go/pivot/kill khi vòng khai pha R; đồng thời đóng sổ, archive và mở vòng mới cho mọi vòng mà không reset hoặc phá sản phẩm đang chạy
---

# $viper-repeat — pha R hoặc đóng sổ vòng
...
Nếu vòng khai `R`, sửa `STATE.md` → `Pha hiện tại : R`. Nếu không khai R, giữ pha vừa
xong và dùng workflow này như bước đóng sổ. `repeat.py` sẽ tự đặt lại `V` khi mở vòng
mới — đó là chỗ duy nhất máy tự đổi pha hộ.

## Bước 1 — Quyết định từ số liệu

**Vòng này có khai pha R không?** Nếu không, **bỏ qua cả Bước 1**: không bịa quyết
định go/pivot/kill chỉ để chuyển vòng. Đi thẳng Bước 2 để archive/bookkeeping và mở
vòng kế theo kế hoạch; cập nhật trạng thái ở `ROADMAP.md §1` và `CAPABILITIES-MAP.md`.
Nếu vòng khai R nhưng chưa có số liệu đủ tin cậy, ghi rõ kết luận “chưa đủ dữ liệu” thay
vì ép thành GO/PIVOT/KILL ([VIPER.md §1.4](../../../VIPER.md)).
...
- Không quay vòng khi vòng khai R mà chưa có quyết định hợp lệ trong `DECISIONS.md` — quay vòng không thay được quyết định. Vòng không khai R thì không có bước này.
