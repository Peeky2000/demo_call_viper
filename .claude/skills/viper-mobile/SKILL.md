...
|---|---|---|
| `.mcp.json` ở gốc repo | Phiên chính (meta tự tay dùng) | `mobile` + `marionette` |
| `mcpServers` trong frontmatter mỗi `viper-user-*` | 6 vai dùng thử | `mobile` + `marionette` (bên cạnh `browser`) |
